...
function setScore(entity, objective, score) {
    return world.scoreboard.getObjective(objective).setScore(entity.scoreboard, score);
}
function addScore(entity, objective, score) {
    let scoreOld = getScore(entity, objective);
    return world.scoreboard.getObjective(objective).setScore(entity.scoreboard, scoreOld + score);
}
